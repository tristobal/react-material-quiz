      ...
      <div>
        <Paper className={this.props.classes.root} elevation={4}>
          ...
          <div className={this.props.classes.footer}>
            <Button onClick={this.revealCorrect} variant="raised" color="secondary">Submit</Button>
      
            {
              (moveRight) ? (
                <Button onClick={this.moveNext} variant="raised" color="primary" style={{float: "right"}}>
                  Next
                </Button>
              ) : (
            ...
            {
              (moveLeft) ? (
                <Button onClick={this.movePrevious} disabled variant="raised" color="primary" style={{float: "right", marginRight: "50px"}}>
                  Previous
                </Button>
              ) : (
                <Button onClick={this.movePrevious} variant="raised" color="primary" style={{float: "right", marginRight: "50px"}}>
                  Previous
                </Button>
              )
            }
...
PaperSheet.propTypes = { classes: PropTypes.object.isRequired, };
